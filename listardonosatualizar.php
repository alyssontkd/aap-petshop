...
function __autoload($class_name) {
  ...
  foreach($resultadoQuery as $registro) {
    ...
    echo "<tr bgcolor = 'lightsteelblue'><td><a href = 'formularioatualizardono.php?cod=$registro->id_dono' link='$registro->id_dono'><img src='imagens/logo.jpg' width='15' heigth='30' link='$registro->id_dono' /></a><a href = 'formularioatualizardono.php?cod=$registro->id_dono'><img src='img/logo.jpg' width='15' heigth='30' /></a></td><td>" . $registro->nm_dono . "</td><td>" . $registro->tx_email . "</td><td>" . $sexo .  "</td><td>" . $registro->nm_cidade . "</td></tr>";
   }
  echo"</table></center>";
	echo "<hr>";
